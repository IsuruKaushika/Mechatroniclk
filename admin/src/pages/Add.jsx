...
const Add = ({ token }) => {
  ...
  const [subCategory, setSubCategory] = useState('Resistor');
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        <div>
          ...
          <select onChange={(e) => setCategory(e.target.value)} value={category} className='w-full max-w-[500px] px-3 py-2' required>
            ...
            <option value='Capacitors and Resistors'>Capacitors and Resistors</option>
            <option value='Motors and Drivers'>Motors and Drivers</option>
