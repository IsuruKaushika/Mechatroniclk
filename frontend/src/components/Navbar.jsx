...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 flex items-center font-medium z-50 border-b border-gray-200 bg-white px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw] h-24 ">
      ...
      {/* Logo */}
      <Link to="/">
        <img src={assets.logo} className="w-14 mx-auto" alt="Logo" />
        <p className='text-[10px] font-[Orbitron] font-semibold'>MechatronicLK</p>
      </Link>
      ...
      <ul className="hidden sm:flex gap-5 text-sm text-gray-700">
        ...
        <NavLink to="/services/3d-design" className="flex flex-col items-center gap-1">
          <p>3D DESIGN</p>
          <hr className="w-2/4 border-none h-[1.5px] bg-gray-700 hidden" />
        </NavLink>
